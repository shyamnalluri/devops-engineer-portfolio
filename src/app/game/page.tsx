...
export default function GamePage() {
  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center relative overflow-hidden bg-gray-900 py-16">
      ...
      {/* Game gradients */}
      <div
        className="absolute top-0 right-0 w-[600px] h-[600px] bg-gradient-to-br from-red-500/15 via-orange-500/10 to-amber-500/5 rounded-full blur-3xl"
        aria-hidden="true"
      />
      <div
        className="absolute -bottom-10 -left-10 w-[500px] h-[500px] bg-gradient-to-br from-blue-600/15 via-indigo-500/10 to-purple-600/5 rounded-full blur-3xl"
        aria-hidden="true"
      />

      {/* Binary pattern overlay */}
      <div
        className="absolute inset-0 bg-[url('/noise.svg')] opacity-[0.03] z-0"
        aria-hidden="true"
      />
      ...
      {!gameStarted ? (
        ...
        >
          ...
          <p className="text-gray-300 mb-8 text-lg">
            Escape from the relentless Jenkins CI/CD pipelines that are chasing you, while avoiding
            obstacles in your DevOps journey!
          </p>
          ...
          <div className="mb-8 p-6 bg-gray-800/60 rounded-lg border border-gray-700/50">
            ...
            <ul className="text-left text-gray-300 space-y-3">
              <li className="flex items-start gap-3">
                ...
                <span>
                  Press{' '}
                  <strong className="text-white bg-gray-700 px-2 py-0.5 rounded font-mono">
                    ↑ Up Arrow
                  </strong>{' '}
                  or{' '}
                  <strong className="text-white bg-gray-700 px-2 py-0.5 rounded font-mono">
              ...
              <li className="flex items-start gap-3">
                ...
                <ul className="ml-6 space-y-2 mt-2">
                  <li className="flex items-center gap-2">
                    ...
                    <span>
                      <strong className="text-blue-400">Shield</strong> - Protects from one
                      collision
                    </span>
                  </li>
                  <li className="flex items-center gap-2">
                    ...
                    <span>
                      <strong className="text-yellow-400">Cloud</strong> - Super jump ability
                    </span>
                  </li>
                  <li className="flex items-center gap-2">
                    <span className="inline-block w-3 h-3 rounded-full bg-green-400"></span>
                    <span>
                      <strong className="text-green-400">Slow</strong> - Slows down obstacles
                    </span>
                  </li>
                </ul>
              </li>
