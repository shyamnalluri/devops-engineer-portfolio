    ...
    if (gameRef.current) {
      class GameScene extends Phaser.Scene {
        ...
        create() {
          ...
          this.dangerZone = this.add
            .rectangle(width * 0.15, height - 10, width * 0.1, 5, 0xff0000)
            .setOrigin(0, 0.5);
          ...
          this.add
            .text(width / 2, 50, 'Press SPACE or UP ARROW to Jump', {
              fontSize: '16px',
              color: '#ffff99',
              fontFamily: 'Arial, sans-serif',
            })
        ...
        spawnObstacle() {
          ...
          const obstacle = this.obstacles
            .create(width + 100, obstacleY, obstacleType)
          ...
          if (this.score > 300 && Phaser.Math.Between(1, 10) > 7) {
            const secondObstacle = this.obstacles
              .create(width + 150, height - 80, Phaser.Math.RND.pick(this.obstacleTypes))
              .setScale(0.4) as Phaser.Physics.Arcade.Sprite;
            ...
            if (secondObstacle.body) {
              ...
              secondObstacle.body.setOffset(
                secondObstacle.width * 0.2,
                secondObstacle.height * 0.2
              );
            }
          }
        ...
        spawnPowerUp() {
          ...
          const powerUp = this.powerUps
            .create(width + 100, Phaser.Math.Between(height - 200, height - 100), powerUpType)
            .setScale(0.4) as Phaser.Physics.Arcade.Sprite;
        ...
        gameOver() {
          ...
          this.add.rectangle(width / 2, height / 2, 300, 220, 0x000000, 0.8);
          ...
          if (newHighScore) {
            this.add
              .text(width / 2, height / 2 + 30, 'New High Score!', {
                fontSize: '20px',
                color: '#ffcc66',
                fontFamily: 'Arial, sans-serif',
              })
  ...
  return (
    <div className="relative flex flex-col items-center">
        ...
        <div className="absolute inset-0 flex items-center justify-center bg-black/50 rounded-xl">
          <div className="bg-gray-900 border border-gray-700 rounded-lg p-8 shadow-2xl max-w-md mx-4">
            ...
            <p className="text-xl mb-6 text-gray-200">
              Your score: <span className="text-orange-500 font-bold">{finalScore}</span>
            </p>
            <button
      ...
      <div className="mt-6 text-center text-gray-400 space-y-2 bg-gray-800/50 p-4 rounded-lg">
        ...
        <p>
          <span className="text-white font-medium">↑ Up Arrow</span> or{' '}
