        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 md:gap-7 items-center">
          ...
          >
            <div className="relative w-full max-w-[240px] sm:max-w-[260px] mx-auto">
              ...
              <span
                className="absolute -top-3 -left-3 w-[88%] h-[88%] rounded-[26px] bg-gradient-to-br from-orange-500 to-red-500 opacity-80 blur-[2px]"
                aria-hidden
              ></span>
              <span
                className="absolute -bottom-3 -right-3 w-[88%] h-[88%] rounded-[26px] bg-gradient-to-br from-cyan-500 to-blue-600 opacity-80 blur-[2px]"
                aria-hidden
              ></span>
              {/* Main card with image */}
              <div className="relative rounded-[26px] p-[3px] bg-gradient-to-br from-white/10 to-white/5">
                <div
                  className="relative rounded-[22px] overflow-hidden bg-gray-900"
          ...
          >
            <div className="prose prose-base sm:prose-lg max-w-[66ch] mx-auto prose-invert">
              <p
                className={`text-gray-300 text-mobile-base sm:text-lg leading-[1.7] text-left lg:hyphens-auto transition-all duration-800 ${
              ...
              <p
                className={`text-gray-400 text-mobile-base sm:text-lg leading-[1.7] text-left lg:hyphens-auto mt-4 sm:mt-6 transition-all duration-800 ${
                  textVisible ? 'animate-fade-in' : 'opacity-0'
                }`}
            ...
            {/* Metrics chips */}
            <div
              className={`grid grid-cols-2 gap-4 md:gap-5 mt-4 sm:mt-6 md:mt-8 transition-all duration-800 ${
                textVisible ? 'animate-slide-up' : 'opacity-0 translate-y-8'
              }`}
