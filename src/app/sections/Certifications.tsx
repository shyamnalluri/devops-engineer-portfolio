...
const Certifications = () => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute left-0 top-0 w-48 h-48 sm:w-64 sm:h-64 lg:w-[300px] lg:h-[300px] bg-gradient-to-br from-red-500 to-yellow-500 opacity-10 rounded-full -z-0 blur-3xl" />
