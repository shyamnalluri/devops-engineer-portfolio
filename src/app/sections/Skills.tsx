...
const categoryAccent: Record<string, { header: string; hoverBorder: string; stripe: string }> = {
  'Cloud & Infrastructure': {
    ...
    stripe: 'bg-sky-500/30',
  },
  'Container & Orchestration': {
    header: 'bg-teal-500/15 text-teal-200',
    hoverBorder: 'hover:border-teal-500/40',
    stripe: 'bg-teal-500/30',
  },
  'CI/CD & GitOps': {
    header: 'bg-violet-500/15 text-violet-200',
    hoverBorder: 'hover:border-violet-500/40',
    stripe: 'bg-violet-500/30',
  },
  'Monitoring & Observability': {
    header: 'bg-amber-500/15 text-amber-200',
    hoverBorder: 'hover:border-amber-500/40',
    stripe: 'bg-amber-500/30',
  },
  'Security & Policy': {
    header: 'bg-pink-500/15 text-pink-200',
    hoverBorder: 'hover:border-pink-500/40',
    stripe: 'bg-pink-500/30',
  },
  'Programming & OS': {
    header: 'bg-emerald-500/15 text-emerald-200',
    hoverBorder: 'hover:border-emerald-500/40',
    stripe: 'bg-emerald-500/30',
  },
};
                  ...
                  <div key={category.name} className="mb-3 sm:mb-4">
                    ...
                    <div className="mb-2 sm:mb-3">
                      <div className="flex items-center">
                        ...
                        <h3
                          className={`px-2 sm:px-3 text-xs sm:text-sm font-bold rounded-full py-1 ${accent.header}`}
                        >
                          {category.name}
                        </h3>
                        <div className="flex-1 h-px bg-gradient-to-r from-transparent via-gray-600 to-transparent"></div>
