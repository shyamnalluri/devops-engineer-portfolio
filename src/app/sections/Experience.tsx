    ...
    >
      ...
      >
        ...
        >
          ...
          <span className="w-1 h-1 rounded-full bg-gray-500" />
          <span className={`text-xs uppercase tracking-wide font-medium px-2 py-0.5 rounded border transition-all duration-200 text-orange-300 bg-orange-500/10 border-orange-500/20 hover:bg-orange-500/15`}>
            {data.type}
          </span>
        </div>
  ...
  return (
    <section id="experience" className="section-wrap" role="region" aria-label="Experience and education timeline">
      ...
      <div className="section-header" ref={headerRef}>
        <h2 className="section-title"><span ref={titleRef} className="inline-block">Experience & Education</span></h2>
      ...
      <div className="mt-2 md:mt-4 grid grid-cols-1 xl:grid-cols-2 gap-4 md:gap-6 xl:gap-8">
        ...
        >
          <h3 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-white mb-4 md:mb-6 relative">
            ...
            <div className="absolute -bottom-3 sm:-bottom-4 left-0 w-20 sm:w-24 lg:w-28 h-1 sm:h-1.5 bg-gradient-to-r from-orange-500 to-orange-400 rounded-full animate-scale-in" style={{ animationDelay: '400ms' }} />
            <div className="absolute -bottom-1.5 sm:-bottom-2 left-0 w-16 sm:w-20 h-0.5 sm:h-1 bg-gradient-to-r from-orange-400 to-yellow-400 rounded-full animate-scale-in" style={{ animationDelay: '500ms' }} />
          </h3>
        ...
        >
          <h3 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-white mb-4 md:mb-6 relative">
            ...
            <div className="absolute -bottom-3 sm:-bottom-4 left-0 w-20 sm:w-24 lg:w-28 h-1 sm:h-1.5 bg-gradient-to-r from-orange-500 to-orange-400 rounded-full animate-scale-in" style={{ animationDelay: '600ms' }} />
            <div className="absolute -bottom-1.5 sm:-bottom-2 left-0 w-16 sm:w-20 h-0.5 sm:h-1 bg-gradient-to-r from-orange-400 to-yellow-400 rounded-full animate-scale-in" style={{ animationDelay: '700ms' }} />
          </h3>
          <div className="relative">
            {/* Background timeline - Subtle and professional */}
            <div className="absolute left-[11px] top-0 bottom-0 w-px bg-gradient-to-b from-gray-600 to-gray-800 rounded-full opacity-60" />
