        ...
        >
          ...
          <div className="text-center mb-20">
            ...
            >
              ...
              <span className="text-orange-400 font-semibold"> Click timeline nodes to expand details, click again to collapse!</span>
            </motion.p>
          </div>          <div className="grid lg:grid-cols-2 gap-20 xl:gap-24">
