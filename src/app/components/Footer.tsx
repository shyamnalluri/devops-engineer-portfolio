...
const Footer = () => {
  ...
  return (
    <footer className="relative overflow-hidden border-t border-gray-800 bg-black/80 py-6" role="contentinfo" aria-label="Site footer">
      ...
      <div ref={footerRef} className="container mx-auto px-6 relative z-10">
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <p className="text-gray-400 text-sm flex items-center gap-2 text-center md:text-left">
            © {new Date().getFullYear()} Shyam Nalluri. Built with Next.js & Tailwind CSS · AI-assisted, refined by me.
          </p>
          ...
          <div className="flex items-center gap-3">
            ...
            <button onClick={copyEmail} className="text-gray-400 hover:text-orange-400 transition-colors p-2 rounded-md hover:bg-gray-800/60 focus:outline-none focus:ring-2 focus:ring-orange-500/40 focus:ring-offset-2 focus:ring-offset-black" aria-label="Copy email to clipboard">
              {emailCopied ? (
                <svg viewBox="0 0 24 24" width="18" height="18" className="text-green-400" fill="currentColor" aria-hidden>
