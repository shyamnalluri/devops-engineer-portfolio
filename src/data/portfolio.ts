...
export const personalInfo: PersonalInfo = {
  ...
  description:
    'Architecting enterprise-grade cloud infrastructure with 5+ years of expertise in DevSecOps and platform automation',
  location: 'India',
...
export const experienceData: ExperienceItem[] = [
  {
    ...
    description:
      'Leading DevSecOps initiatives and platform automation for enterprise clients, architecting secure cloud-native solutions across AWS and Azure environments.',
  ...
  },
  {
    ...
    description:
      'Specialized in container orchestration, automation frameworks, and cloud infrastructure management with focus on scalability and security.',
  ...
  },
  {
    ...
    description:
      'Foundation building in system administration, automation scripting, and infrastructure management with emphasis on Linux environments.',
  ...
  },
  {
    ...
    period: '2015 - 2017',
    description:
      'Advanced studies in Cloud Computing, Distributed Systems, and Software Engineering with focus on scalable system architecture and modern DevOps practices.',
  ...
  },
  {
    ...
    period: '2011 - 2015',
    description:
      'Comprehensive foundation in Computer Science and Engineering with emphasis on Software Development, System Architecture, and Programming fundamentals.',
